export const punkgoes = {
  ...
  year: "2019",
  description:
    "Fearless wanted a nostalgic feel to promote the latest Punk Goes Acoustic, so we redesigned everything to look like the old MySpace website, warts and all."
};
